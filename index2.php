...
<body style="background-image: url(img/bg1.jpg);">
	<?php 	
		...
		$message2 = mysqli_query($connect,'SELECT * FROM message2');
	...
	<div class="col-10 mx-auto pl-0 pr-0 bg-secondary">
		...
		<div class="col-12 mx-auto pl-0 pr-0 bg-warning d-flex">
			...
			<div class=" col-4 pl-0 pr-0 bg-secondary pt-2 text-center btn3" style="height: 60px;">
				<button style="font-size: 100%; color: white;font-size: 20px;">Настройки</button>
			</div>
		</div>
	</div>
	<!-- Сотрудники -->
		...
		<div class="col-7 mx-auto" style="margin-top: 10px; ">
			<div class="col-12 ">
				<form action="insert.php" method="GET">
					<input type="" name="g" placeholder="план"class="col-10 text-center" style="height: 80px;">
					<input type="" name="f" placeholder="срок выполнения"class="col-3 mt-2 text-center" style="height: 30px;">
					<button class="mt-2 bg-success">Добавить план</button>
				</form>
			</div>
		</div>
	...
	<div class="messing col-10 mx-auto pt-3 pl-0 pr-0" style="display: none; background: #7a7a7a">
		<div class="col-12 bg-secondsary ">
			<form action="message2.php" method="GET" class="d-flex">
	...
	<div class="options col-10 mx-auto pt-3 pl-0 pr-0 bg-secondary" style="height: 310px;display: none;">
		<form action="index2.php" method="GET">
			<input type="" name="gl1" placeholder="Название компании" class="col-12 text-center" style="height: 50px;">
			<input type="" name="gh1" placeholder="Описание компании" class="col-12 mt-2 text-center" style="height: 50px;">
